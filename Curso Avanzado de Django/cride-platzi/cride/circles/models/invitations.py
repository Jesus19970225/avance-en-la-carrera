...
class Invitation(CRideModel):
    ...
    This codes are generated by users that are already members of the circle and have a remeaning_invitations value greater than 0.
    """
    ...
    circle = models.ForeignKey('circles.Circle', on_delete=models.Case)
