...
class HomePageTests(unittest.TestCase):
    ...
    def setUp(self):
        self.driver = webdriver.Edge(executable_path = r"C://Users/Jesus David Gomez/Documents/Platzi/Curso de Introducción a Selenium con Python/msedgedriver.exe")
    ...
    def test_count_of_promo_banner_imagenes(self):
