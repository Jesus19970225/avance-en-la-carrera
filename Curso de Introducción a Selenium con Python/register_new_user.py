...
class RegisterNewUser(unittest.TestCase):
    ...
    def test_new_user(self):
        ...
        create_account_botton = driver.find_element_by_xpath('//*[@id="login-form"]/div/div[1]/div[2]/a/span/span')
        self.assertTrue(create_account_botton.is_displayed() and create_account_botton.is_enabled())
        ...
        new_latter_subscription = driver.find_element_by_id('is_subscribed')
        ...
        and new_latter_subscription.is_enabled()
